export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportFileHint: 'Drag and drop or choose a JSON file. The system will auto-detect exported bundles and OpenAI/Codex account JSON.',
      ...
      dataImportDetectedSummary: '{format} · Accounts {account_count} · Proxies {proxy_count}',
      dataImportFormatSub2api: 'Sub2API export data',
      dataImportFormatOpenAI: 'OpenAI / Codex account JSON',
      dataImportBindGroupsHint: 'Optional: directly bind selected groups to every account created in this import. If left empty, the current behavior stays unchanged and no groups are auto-bound.',
