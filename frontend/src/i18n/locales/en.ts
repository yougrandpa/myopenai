export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportHint: 'Supports exported Sub2API JSON / JSON.GZ and OpenAI/Codex account JSON / JSON.GZ for automatic account recognition and batch creation.',
      dataImportWarning: 'Import will batch-create accounts and proxies. When duplicate accounts are detected, their credentials will be refreshed automatically. Ensure existing data does not conflict.',
      dataImportFile: 'Data File / Folder',
      dataImportFileHint: 'Drag multiple JSON / JSON.GZ files, or choose files / a folder directly. The system will batch-detect Sub2API exports and OpenAI/Codex account JSON files automatically.',
      dataImportButton: 'Start Import',
      dataImporting: 'Importing...',
      dataImportSelectFile: 'Please select data files or a folder',
      dataImportChooseFolder: 'Choose Folder',
      dataImportSelectedFiles: '{count} file(s) selected',
      dataImportNoValidFiles: 'No importable JSON / JSON.GZ files were found',
      dataImportParseFailed: 'Failed to parse data file',
      dataImportUnsupportedFormat: 'Unsupported JSON format. Please choose a Sub2API export file or an OpenAI/Codex account JSON file.',
      dataImportGzipUnsupported: 'This browser cannot decompress .json.gz files. Please use a newer Chromium-based browser or unzip the file first.',
      dataImportFailed: 'Data import failed',
      dataImportDetected: 'Detected import format',
      dataImportDetectedSummary: '{format} · Files {file_count} · Accounts {account_count} · Proxies {proxy_count}',
      ...
      dataImportCompletedWithErrors: 'Import completed with errors: accounts created {account_created}, updated {account_updated}, failed {account_failed}; proxy failed {proxy_failed}',
      ...
      oauth: {
        ...
        openai: {
          ...
          refreshTokenDesc: 'Enter your existing OpenAI Refresh Token(s), or paste exported JSON containing refresh_token. Batch import is supported and the system will validate and create accounts automatically.',
          refreshTokenPlaceholder: 'Paste your OpenAI Refresh Token or exported JSON...\nSupports multiple tokens or a full JSON array',
