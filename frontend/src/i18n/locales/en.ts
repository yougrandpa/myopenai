export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportHint: 'Supports both exported Sub2API JSON and OpenAI/Codex account JSON for automatic account recognition and batch creation.',
      ...
      dataImportFileHint: 'Drag multiple JSON files, or choose files / a folder directly. The system will batch-detect Sub2API exports and OpenAI/Codex account JSON files automatically.',
      ...
      dataImportNoValidFiles: 'No importable JSON files were found',
