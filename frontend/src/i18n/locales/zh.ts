export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportFile: '数据文件',
      dataImportFileHint: '支持拖拽或选择 JSON 文件，系统会自动识别导出格式或 OpenAI/Codex 账号格式。',
      ...
      dataImportDetectedSummary: '{format} · 账号 {account_count} 个 · 代理 {proxy_count} 个',
      dataImportFormatSub2api: 'Sub2API 导出数据',
      dataImportFormatOpenAI: 'OpenAI / Codex 账号 JSON',
      dataImportBindGroupsHint: '可选：为本次导入创建的所有账号直接绑定分组。未选择时保持当前行为，不自动绑定分组。',
